...
export * from 'um-3d-tiles-renderer/core/plugins';

// Export all three.js plugins
export * from 'um-3d-tiles-renderer/three/plugins';

// Override with backward compatible version (no constructor warning)
import { CesiumIonAuthPlugin as CesiumIonAuthPluginDeprecated } from 'um-3d-tiles-renderer/three/plugins';
